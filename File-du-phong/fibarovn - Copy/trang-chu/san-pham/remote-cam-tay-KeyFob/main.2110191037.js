!(function e(t, i, n) {
                ...
                !(function(e, i) {
                    ...
                    if (!s.TweenLite) {
                                ...
                                (this.check = function(p) {
                                    ...
                                    if (0 === v && a) {
                                        if (((u = ("com.greensock." + o).split(".")), (z = u.pop()), (f = l(u.join("."))[z] = this.gsClass = a.apply(a, h)), d))
                                            ...
                                            define.amd &&
                                            define((e.GreenSockAMDPath ? e.GreenSockAMDPath + "/" : "") + o.split(".").pop(), [], function() {
                                                return f;
                                            });
                        ...
                        for (
                            ...
                            (d = r[a] + ",Power" + a), j(new y(null, null, 1, a), d, "easeOut", !0), j(new y(null, null, 2, a), d, "easeIn" + (0 === a ? ",easeNone" : "")), j(new y(null, null, 3, a), d, "easeInOut");
                        (k.linear = c.easing.Linear.easeIn), (k.swing = c.easing.Quad.easeInOut);
                        var x = b("events.EventDispatcher", function(e) {
                            (this._listeners = {}), (this._eventTarget = e || this);
                        });
                        (d = x.prototype),
                        (d.addEventListener = function(e, t, i, n, o) {
                            o = o || 0;
                            var s,
                                r,
                                a = this._listeners[e],
                            ...
                            a.splice(d, 0, { c: t, s: i, up: n, pr: o });
                        }),
                        ...
                        (d.dispatchEvent = function(e) {
                            var t,
                                ...
                                o = this._listeners[e];
                            if (o)
                                for (t = o.length, t > 1 && (o = o.slice(0)), i = this._eventTarget; --t > -1;)(n = o[t]), n && (n.up ? n.c.call(n.s || i, { type: e, target: i }) : n.c.call(n.s || i));
                        });
                        ...
                        b("Ticker", function(e, t) {
                                var i,
                                    ...
                                    g = function(e) {
                                        ...
                                        h > z && (l += h - m),
                                            ...
                                            (d.time = (S - l) / 1e3),
                                            (t = d.time - a),
                                            (!i || t > 0 || e === !0) && (d.frame++, (a += t + (t >= r ? 0.004 : r - t)), (o = !0)),
                                            e !== !0 && (s = n(g)),
                                            o && d.dispatchEvent(w);
                                    };
                                x.call(d),
                                    ...
                                    (d.wake = function(e) {
                                        null !== s ? d.sleep() : e ? (l += -S + (S = C())) : d.frame > 10 && (S = C() - z + 5),
                                            (n =
                                                0 === i ?
                                                f :
                                                c && T ?
                            ...
                            (d = c.Ticker.prototype = new c.events.EventDispatcher()),
                            (d.constructor = c.Ticker);
                        ...
                        A(),
                            ...
                            (d._enabled = function(e, t) {
                                return (
                                    ...
                                    t !== !0 && (e && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !e && this.timeline && this._timeline._remove(this, !0)), !1
                                );
                            }),
                            ...
                            (d.timeScale = function(e) {
                                ...
                                for (
                                    ...
                                    ((t = this._pauseTime), (i = t || 0 === t ? t : this._timeline.totalTime()), (this._startTime = i - ((i - this._startTime) * this._timeScale) / e)),
                                    this._timeScale = e,
                            ...
                            (d.paused = function(e) {
                                ...
                                return (
                                    ...
                                    (p || e || h.wake(),
                                        (t = n.rawTime()),
                                        (i = t - this._pauseTime), !e && n.smoothChildTiming && ((this._startTime += i), this._uncache(!1)),
                                        (this._pauseTime = e ? t : null),
                                        (this._paused = e),
                                        (this._active = this.isActive()), !e && 0 !== i && this._initted && this.duration() && ((t = n.smoothChildTiming ? this._totalTime : (t - this._startTime) / this._timeScale), this.render(t, t === this._totalTime, !0))),
                        ...
                        (d._sortChildren = !1),
                        (d.add = d.insert = function(e, t, i, n) {
                            var o, s;
                            if (
                        ...
                        var M = b(
                                ...
                                function(t, i, n) {
                                    ...
                                    if (((this._overwrite = d = null == d ? B[M.defaultOverwrite] : "number" == typeof d ? d >> 0 : B[d]), (a || t instanceof Array || (t.push && m(t))) && "number" != typeof t[0]))
                                        for (this._targets = r = z(t), this._propLookup = [], this._siblings = [], o = 0; o < r.length; o++)
                                            (s = r[o]),
                                            s ?
                                            "string" != typeof s ?
                                            s.length && s !== e && s[0] && (s[0] === e || (s[0].nodeType && s[0].style && !s.nodeType)) ?
                                            (r.splice(o--, 1), (this._targets = r = r.concat(z(s)))) :
                                            ((this._siblings[o] = Z(s, this, !1)), 1 === d && this._siblings[o].length > 1 && te(s, this, null, 1, this._siblings[o])) :
                                            ((s = r[o--] = M.selector(s)), "string" == typeof s && r.splice(o + 1, 1)) :
                                            r.splice(o--, 1);
                        ...
                        (M.version = "1.20.3"),
                        (M.defaultEase = d._ease = new y(null, null, 1, 1)),
                        ...
                        var E = [],
                            ...
                            H = function(e) {
                                for (var t, i = this._firstPT, n = 1e-6; i;)
                                    ...
                                    i.m ? (t = i.m(t, this._target || i.t)) : t < n && t > -n && !i.blob && (t = 0),
                            ...
                            X = function(e, t, i, n) {
                                ...
                                for (
                                    ...
                                    o = e.match(F) || [],
                                    s = t.match(F) || [],
                                    n && ((n._next = null), (n.blob = 1), (l._firstPT = l._applyPT = n)),
                                    d = s.length,
                                    a = 0; a < d; a++
                                )
                                    (p = s[a]),
                                    (h = t.substr(c, t.indexOf(p, c) - c)),
                                    (u += h || !a ? h : ","),
                                    (c += h.length),
                                    z ? (z = (z + 1) % 5) : "rgba(" === h.substr(-5) && (z = 1),
                                    p === o[a] || o.length <= a ?
                                    (u += p) :
                                    (u && (l.push(u), (u = "")),
                                        (r = parseFloat(o[a])),
                            ...
                            q = function(e, t, i, n, o, s, r, a, d) {
                                ...
                                if (
                                    (("number" != typeof c || ("number" != typeof n && !u)) &&
                                        (r || isNaN(c) || (!u && isNaN(n)) || "boolean" == typeof c || "boolean" == typeof n ?
                                            ((z.fp = r), (h = X(c, u ? parseFloat(z.s) + z.c : n, a || M.defaultStringFilter, z)), (z = { t: h, p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: o || t, pr: 0, m: 0 })) :
                                            ((z.s = parseFloat(c)), u || (z.c = parseFloat(n) - z.s || 0))),
                                        z.c)
                                )
                                    return (z._next = this._firstPT) && (z._next._prev = z), (this._firstPT = z), z;
                            },
                            Y = (M._internals = { isArray: m, isSelector: O, lazyTweens: E, blobDif: X }),
                            G = (M._plugins = {}),
                            U = (Y.tweenLookup = {}),
                            W = 0,
                            $ = (Y.reservedProps = {
                        ...
                        setTimeout(J, 1),
                            (N._updateRoot = M.render = function() {
                                var e, t, i;
                        ...
                        var Z = function(e, t, i) {
                                var n,
                                    o,
                                    s = e._gsTweenID;
                                if ((U[s || (e._gsTweenID = s = "t" + W++)] || (U[s] = { target: e, tweens: [] }), t && ((n = U[s].tweens), (n[(o = n.length)] = t), i)))
                            ...
                            te = function(e, t, i, n, o) {
                                ...
                                for (s = o.length; --s > -1;)
                                    ...
                                    (a._timeline !== t._timeline ?
                                        ((h = h || ie(t, 0, z)), 0 === ie(a, h, z) && (l[c++] = a)) :
                                        a._startTime <= p && a._startTime + a.totalDuration() / a._timeScale > p && (((z || !a._initted) && p - a._startTime <= 2e-10) || (l[c++] = a)));
                                for (s = c; --s > -1;)
                        ...
                        (d._init = function() {
                            ...
                            if (
                                ((this._ease = p = p ? (p instanceof y ? p : "function" == typeof p ? new y(p, r.easeParams) : k[p] || M.defaultEase) : M.defaultEase),
                                    r.easeParams instanceof Array && p.config && (this._ease = p.config.apply(p, r.easeParams)),
                        ...
                        (d._initProps = function(t, i, n, o, s) {
                            ...
                            for (r in this.vars)
                                ...
                                for (this._firstPT = p = { _next: this._firstPT, t: h, p: "setRatio", s: 0, c: 1, f: 1, n: r, pg: 1, pr: h._priority, m: 0 }, a = h._overwriteProps.length; --a > -1;)
                            ...
                            return o && this._kill(o, t) ?
                                ...
                                this._overwrite > 1 && this._firstPT && n.length > 1 && te(t, this, i, this._overwrite, n) ?
                                (this._kill(i, t), this._initProps(t, i, n, o, s)) :
                                (this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)) && (I[t._gsTweenID] = !0), d);
                        }),
                        (d.render = function(e, t, i) {
                            var n,
                                o,
                            ...
                            if (e >= d - 1e-7 && e >= 0)
                                ...
                                (this._startTime === this._timeline._duration && (e = 0),
                                    (h < 0 || (e <= 0 && e >= -1e-7) || (h === u && "isPause" !== this.data)) && h !== e && ((i = !0), h > u && (o = "onReverseComplete")),
                                    (this._rawPrevTime = r = !t || e || h === e ? e : u));
                            else if (e < 1e-7)
                                (this._totalTime = this._time = 0),
                                (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                                (0 !== a || (0 === d && h > 0)) && ((o = "onReverseComplete"), (n = this._reversed)),
                                e < 0 &&
                                ((this._active = !1), 0 === d && (this._initted || !this.vars.lazy || i) && (h >= 0 && (h !== u || "isPause" !== this.data) && (i = !0), (this._rawPrevTime = r = !t || e || h === e ? e : u))),
                                ...
                                3 === l && (p *= 2),
                                    ...
                                    1 === l ? (this.ratio = 1 - p) : 2 === l ? (this.ratio = p) : e / d < 0.5 ? (this.ratio = p / 2) : (this.ratio = 1 - p / 2);
                            } else this.ratio = this._ease.getRatio(e / d);
                            if (this._time !== a || i) {
                                if (!this._initted) {
                                    if ((this._init(), !this._initted || this._gc)) return;
                                    if (!i && this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)))
                                        return (this._time = this._totalTime = a), (this._rawPrevTime = h), E.push(this), void(this._lazy = [e, t]);
                                ...
                                for (
                                    ...
                                    0 === a && (this._startAt && (e >= 0 ? this._startAt.render(e, !0, i) : o || (o = "_dummyGS")), this.vars.onStart && ((0 === this._time && 0 !== d) || t || this._callback("onStart"))),
                                    s = this._firstPT; s;

                                )
                                    s.f ? s.t[s.p](s.c * this.ratio + s.s) : (s.t[s.p] = s.c * this.ratio + s.s), (s = s._next);
                                this._onUpdate && (e < 0 && this._startAt && e !== -1e-4 && this._startAt.render(e, !0, i), t || ((this._time !== a || n || i) && this._callback("onUpdate"))),
                                    o &&
                                    ((this._gc && !i) ||
                                        (e < 0 && this._startAt && !this._onUpdate && e !== -1e-4 && this._startAt.render(e, !0, i),
                                            n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !t && this.vars[o] && this._callback(o),
                                            0 === d && this._rawPrevTime === u && r !== u && (this._rawPrevTime = 0)));
                            }
                        }),
                        (d._kill = function(e, t, i) {
                            ...
                            if ((m(t) || O(t)) && "number" != typeof t[0])
                                ...
                                if (a) {
                                    ...
                                    for (s in h)
                                        (r = a[s]) &&
                                        (c && (r.f ? r.t[r.p](r.s) : (r.t[r.p] = r.s), (d = !0)),
                                            r.pg && r.t._kill(h) && (d = !0),
                        ...
                        (M.delayedCall = function(e, t, i, n, o) {
                            return new M(t, 0, { delay: e, onComplete: t, onCompleteParams: i, callbackScope: n, onReverseComplete: t, onReverseCompleteParams: i, immediateRender: !1, lazy: !1, useFrames: o, overwrite: 0 });
                        }),
                        (M.set = function(e, t) {
                            return new M(e, 0, t);
                        }),
                            ...
                            ((d = ne.prototype),
                                ...
                                (d._mod = d._roundProps = function(e) {
                                    for (var t, i = this._firstPT; i;)
                                        (t = e[this._propName] || (null != i.n && e[i.n.split(this._propName + "_").join("")])), t && "function" == typeof t && (2 === i.f ? (i.t._applyPT.m = t) : (i.m = t)), (i = i._next);
                                }),
                ...
                (n._gsQueue || (n._gsQueue = [])).push(function() {
                        ...
                        var e = (n.document || {}).documentElement,
                            ...
                            s = function(i, n) {
                                ...
                                return (
                                    i === t && (null != i.pageXOffset ? (o = "page" + n.toUpperCase() + "Offset") : (i = null != e[o] ? e : document.body)),
                                    function() {
                                        return i[o];
                                    }
                                );
                            ...
                            r = function(i, n) {
                                var r = o(i).getBoundingClientRect(),
                                    ...
                                    h = { x: r.left - d.left, y: r.top - d.top };
                            ...
                            d = n._gsDefine.plugin({
                                ...
                                init: function(e, i, n) {
                                    return (
                                        ...
                                        null != i.x ? (this._addTween(this, "x", this.x, a(i.x, e, "x") - (i.offsetX || 0), "scrollTo_x", !0), this._overwriteProps.push("scrollTo_x")) : (this.skipX = !0),
                                        null != i.y ? (this._addTween(this, "y", this.y, a(i.y, e, "y") - (i.offsetY || 0), "scrollTo_y", !0), this._overwriteProps.push("scrollTo_y")) : (this.skipY = !0), !0
                                    );
                                },
                                set: function(e) {
                                    ...
                                    this.x < 0 && (this.x = 0),
                                        this.y < 0 && (this.y = 0),
                                        this._autoKill &&
                                        (!this.skipX && (r > a || r < -a) && n < i(this._target, "x") && (this.skipX = !0), !this.skipY && (s > a || s < -a) && o < i(this._target, "y") && (this.skipY = !0),
        ...
        function(e, t, i) {
            !(function(t, n) {
                "function" == typeof define && define.amd ?
                    ...
                    "object" == typeof i ?
                    (e("gsap"), n(e("scrollmagic"), TweenMax, TimelineMax)) :
                    n(t.ScrollMagic || (t.jQuery && t.jQuery.ScrollMagic), t.TweenMax || t.TweenLite, t.TimelineMax || t.TimelineLite);
            })(this, function(e, t, i) {
                "use strict";
                var n = "animation.gsap",
                    o = window.console || {},
                    s = Function.prototype.bind.call(o.error || o.log || function() {}, o);
                e || s("(" + n + ") -> ERROR: The ScrollMagic main module could not be found. Please make sure it's loaded before this plugin or use an asynchronous loader like requirejs."),
                    t || s("(" + n + ") -> ERROR: TweenLite or TweenMax could not be found. Please make sure GSAP is loaded before ScrollMagic or use an asynchronous loader like requirejs."),
                    ...
                    e.Scene.extend(function() {
                        ...
                        var r = function() {
                            if (e) {
                                ...
                                e.repeat && e.repeat() === -1 ?
                                    ...
                                    t != e.progress() && (0 === o.duration() ? (t > 0 ? e.play() : e.reverse()) : o.tweenChanges() && e.tweenTo ? e.tweenTo(t * e.duration()) : e.progress(t).pause());
                            }
                        };
                        (o.setTween = function(n, a, d) {
                            ...
                            if (
                                (e && o.removeTween(),
                                    (e = h),
                                    n.repeat && n.repeat() === -1 && (e.repeat(-1), e.yoyo(n.yoyo())),
                                    o.tweenChanges() && !e.tweenTo && s(2, "WARNING: tweenChanges will only work if the TimelineMax object is available for ScrollMagic."),
                                    e && o.controller() && o.triggerElement() && o.loglevel() >= 2)
                            ) {
        ...
        function(e, t, i) {
            t.exports = function() {
                ...
                function t() {
                    ...
                    window.fibScreenInfo = { currentBreakpoint: t, screenSize: i };
                }
    ...
    9: [
        function(e, t, i) {
            function n() {
                (this.isDesktop = Modernizr.mq(d)),
                (this.header = a("header")),
                this.header.on("click", this.headerClickHandler.bind(this)),
                    (this.nav = a("nav")),
                    (this.navSwitch = a("#menu-toggle")),
                    this.navSwitch.on("click", this.toggleHandler.bind(this)),
                    (this.topNavContainerHeight = this.header.find("> .container").height()),
                    (this.subNavs = {}),
                    this.nav.find(".menu-item-has-children").each(this.createSubNavItem.bind(this)),
                    (this.subNavOpen = !1),
                    this.nav.on("subnav:open", this.subNavOpenHandler.bind(this)),
                    this.nav.on("subnav:close", this.subNavCloseHandler.bind(this)),
                    (this.langsel = new r(this.nav)),
                    this.nav.on("langsel:open", this.langSelOpenHandler.bind(this)),
                    this.nav.on("langsel:close", this.langSelCloseHandler.bind(this)),
                    this.showFirstSubNav(),
                    a(".site-wrapper").hasClass("has-secondary-nav") && ((this.scrollPosition = a(window).scrollTop()), (this.userScrolled = !1), (this.secNav = new s(this.nav))),
                    a(window)
                    .one("wheel mousewheel touchmove", this.windowWheelHandler.bind(this))
                    .on("scroll", this.windowScrollHandler.bind(this))
                    .on("keyup", this.windowKeyupHandler.bind(this))
                    .on("resize", this.windowResizeHandler.bind(this));
            }
            ...
            function s(e) {
                (this.isDesktop = Modernizr.mq(d)),
                (this.header = a("header")),
                (this.element = this.header.find("#secondary-nav")),
                (this.links = this.element.find(".links")),
                (this.linksVisible = !1),
                this.isDesktop || this.links.css({ display: "flex" }).hide(),
                    (this.toggleButton = this.element.find(".link-toggle")),
                    this.toggleButton.on("click", this.toggleSecNav.bind(this)),
                    (this.nav = e),
                    this.nav.on("subnav:open", this.subNavOpenHandler.bind(this)),
                    this.nav.on("subnav:close", this.subNavCloseHandler.bind(this)),
                    a(window).on("resize", this.windowResizeHandler.bind(this));
            }
            ...
            a.extend(n.prototype, {
                    ...
                    show: function() {
                        this.nav.fadeIn(100), this.nav.css({ "overflow-y": "scroll" }), a("body").css({ overflow: "hidden" }), this.secNav && this.secNav.toggleSecNav();
                    },
                    hide: function() {
                        this.nav.fadeOut(
                                100,
                            ...
                            this.nav.css({ "overflow-y": "auto" }),
                            a("body").css({ overflow: "auto" });
                    },
                    reset: function() {
                        this.navSwitch.removeClass("active"), this.nav.removeAttr("style"), this.subNavs && this.hideSub(), a("body").css({ overflow: "auto" });
                    },
                    hideSub: function() {
                    ...
                    subNavOpenHandler: function(e, t, i) {
                        this.langsel.hide(),
                            this.subNavs["level" + i].forEach(function(e) {
                                e.subid !== t && e.hide();
                            }),
                    ...
                    windowScrollHandler: function() {
                        clearTimeout(window.fibScrollTimeout),
                            (window.fibScrollTimeout = setTimeout(
                                function() {
                                    var e = a(window).scrollTop();
                                    !this.userScrolled ||
                                        this.subNavOpen ||
                                        this.langsel.open ||
                                        (!this.isDesktop && this.secNav && this.secNav.linksVisible && this.secNav.toggleSecNav(),
                                            e > this.scrollPosition && e > this.topNavContainerHeight && this.header.addClass("fold-active"),
                                            e < this.scrollPosition && this.header.removeClass("fold-active"),
                    ...
                    windowResizeHandler: function() {
                        (this.topNavContainerHeight = this.header.find("> .container").height()),
                        this.isDesktop && (this.header.removeClass("subnav-active mobnav-active"), this.reset(), this.showFirstSubNav()),
                            (this.isDesktop = Modernizr.mq(d));
                    },
                ...
                a.extend(s.prototype, {
                    ...
                    windowResizeHandler: function() {
                        (this.isDesktop = Modernizr.mq(d)), this.isDesktop ? this.links.show() : this.links.css({ display: "flex" }).hide();
                    },
                }),
    ...
    11: [
        function(e, t, i) {
            ...
            !(function(e, t, i, n) {
                ...
                (e.fn[r.name].defaults = { contextClass: "jquery-" + r.name, modules: [] });
            })(n, window, document),
            (function(e, t, i, n) {
                "use strict";
                var o = { ns: "typographer", name: "common" },
                    s = /([.?*+^$[\]\\(){}|-])/g;
                (o.fullName = o.ns + "_" + o.name),
                (e[o.fullName] = e[o.fullName] || {}),
                (e[o.fullName].normalizeTagNames = function(t) {
            ...
            (function(e, t, i, n) {
                ...
                function r(e) {
                    for (var t, i = {}, n = 0; n < e.length; n++) {
                        ...
                        for (var d = 0; d < s.length; d++) {
                            var h = s.charAt(d),
                                p = t[h];
                            t = null == p ? (t[h] = d === s.length - 1 ? { $: r } : {}) : 0 === p ? (t[h] = { $: r }) : t[h];
                        }
                    }
                    return i;
                }
                ...
                var p = { ns: "typographer", name: "hyphen" };
                (p.fullName = p.ns + "_" + p.name),
                (o.prototype.init = function() {
                    (this.options.ignoreTags = l.normalizeTagNames(this.options.ignoreTags)),
                    this.$context.addClass(this.options.contextClass),
                        (o.trie = o.trie || []),
                        o.trie[this.options.lang] || this.rebuildTrie(this.options.lang),
                        this.execute();
                }),
                (o.prototype.execute = function() {
                ...
                (e.fn[p.fullName].entities = { shy: "­" }),
                (e.fn[p.fullName].defaults = { contextClass: "jquery-" + p.ns + "-" + p.name, lang: "pl", minWordLength: 3, minLeft: 2, minRight: 2, ignoreTags: ["pre", "code"], ignoreClass: "ignore-" + p.name }),
                (e[p.fullName] = { splitWord: o.splitWord, hyphenate: o.hyphenate });
            ...
            (function(e, t, i, n) {
                ...
                var r = { ns: "typographer", name: "orphan" };
                (r.fullName = r.ns + "_" + r.name),
                (o.prototype.init = function() {
                ...
                (o.deorphanize = function(t, i) {
                    return (
                        (i = e.extend({}, e.fn[r.fullName].defaults, i)),
                        o.findOrphanRegex || s(i),
                        (t = t.replace(o.findOrphanRegex, function(e, i, n) {
                ...
                (e.fn[r.fullName].entities = { nbsp: " " }),
                (e.fn[r.fullName].defaults = { contextClass: "jquery-" + r.ns + "-" + r.name, forbidden: ["a", "i", "o", "u", "w", "z"], ignoreTags: ["pre", "code"], ignoreClass: "ignore-" + r.name }),
                (e[r.fullName] = { deorphanize: o.deorphanize });
                var a = e.typographer_common,
                    d = e.fn[r.fullName].entities;
            })(n, window, document),
            (function(e) {
                (e.fn.typographer_hyphen.patterns = e.fn.typographer_hyphen.patterns || {}),
                (e.fn.typographer_hyphen.patterns.pl = [
                    ".ćć8",
                    ".ćł8",
                    ".ćń8",
                    ".ćś8",
                ...
                (e.fn.typographer_hyphen.patterns.exceptions = e.fn.typographer_hyphen.patterns.exceptions || {}),
                (e.fn.typographer_hyphen.patterns.exceptions.pl = {
                    bezach: ["be", "zach"],
                    bezami: ["be", "zami"],
    ...
    12: [
        function(e, t, i) {
            ...
            function o(e) {
                ...
                (this.width = this.ratio * (e.width || 320)),
                (this.height = this.ratio * (e.height || 100)),
                (this.MAX = this.height / 2),
                (this.speed = e.speed || 0.1),
                (this.amplitude = e.amplitude || 1),
                (this.canvas = document.createElement("canvas")),
                (this.canvas.width = this.width),
                (this.canvas.height = this.height),
                e.cover ? (this.canvas.style.width = this.canvas.style.height = "100%") : ((this.canvas.style.width = this.cache.width / this.ratio + "px"), (this.canvas.style.height = this.cache.height / this.ratio + "px")),
                    (this.container = e.container || document.body),
                    this.container.appendChild(this.canvas),
                    (this.ctx = this.canvas.getContext("2d")),
                    (this.curves = []);
                for (var t = 0; t < o.prototype.COLORS.length; t++)
                    for (var i = o.prototype.COLORS[t], s = 0;
                        (s < 3 * Math.random()) | 0; s++) this.curves.push(new n({ controller: this, color: i }));
                e.autostart && this.start();
            }
            (n.prototype.respawn = function() {
                (this.amplitude = 0.3 + 0.7 * Math.random()), (this.seed = Math.random()), (this.open_class = (2 + 3 * Math.random()) | 0);
            }),
            (n.prototype.equation = function(e) {
                ...
                return Math.abs(i) < 0.001 && this.respawn(), i;
            }),
            (n.prototype._draw = function(e) {
                this.tick += this.controller.speed * (1 - 0.5 * Math.sin(this.seed * Math.PI));
                var t = this.controller.ctx;
                t.beginPath();
                for (var i, n, o, s = this.controller.width / 2 + (-this.controller.width / 4 + this.seed * (this.controller.width / 2)), r = this.controller.height / 2, a = -3; a <= 3;)
                    (i = s + (a * this.controller.width) / 4), (n = r + e * this.equation(a)), (o = o || i), t.lineTo(i, n), (a += 0.01);
                var d = Math.abs(this.equation(0)),
                    h = t.createRadialGradient(s, r, 1.15 * d, s, r, 0.3 * d);
    ...
    13: [
        function(e, t, i) {
            function n(e, t) {
                ...
                Object.assign(this, s, t, i),
                    (this.transformProperty = void 0 === e.style.transform ? "webkitTransform" : "transform"),
                    (this.depths = []),
                    (this.ix = 0),
                    (this.iy = 0),
                    (this.mx = 0),
            ...
            e(7);
            var o = e(6),
                s = { relativeInput: !1, clipRelativeInput: !1, invertX: !0, invertY: !0, limitX: !1, limitY: !1, scalarX: 10, scalarY: 10, frictionX: 0.1, frictionY: 0.1, originX: 0.5, originY: 0.5 },
                r = n.prototype;
            (r.data = function(e, t) {
            ...
            (r.onAnimationFrame = function() {
                this.updateBounds(),
                    ...
                    isNaN(parseFloat(this.limitX)) || (this.mx = o.clamp(this.mx, -this.limitX, this.limitX)),
                    isNaN(parseFloat(this.limitY)) || (this.my = o.clamp(this.my, -this.limitY, this.limitY)),
            ...
            (r.onMouseMove = function(e) {
                var t = e.clientX,
                    i = e.clientY;
                this.relativeInput ?
                    (this.clipRelativeInput && ((t = Math.max(t, this.ex)), (t = Math.min(t, this.ex + this.ew)), (i = Math.max(i, this.ey)), (i = Math.min(i, this.ey + this.eh))),
                        (this.ix = (t - this.ex - this.ecx) / this.erx),
                        (this.iy = (i - this.ey - this.ecy) / this.ery)) :
                    ((this.ix = (t - this.wcx) / this.wrx), (this.iy = (i - this.wcy) / this.wry));
            }),
            (t.exports = n);
        },
        { 6: 6, 7: 7 },
    ...
    14: [
            ...
            n(function() {
                function e() {
                    ...
                    e.length > 0 &&
                        n.each(e, function(e, t) {
                            ...
                            return (!(!a || Modernizr.mq("screen and (min-width: " + a + "px)")) ||
                                ("true" === d && l.prop("loop", !0),
                                    i.replaceWith(l),
                                    n(t).find("video")[0].load(),
                                    n(t).trigger("lazyvideo.loaded"),
                                    void(
                                        r &&
                                        new o.Scene({ triggerHook: "onCenter", offset: p, triggerElement: l[0], reverse: h })
                                        .on("start", function() {
                ...
                v.length > 0 &&
                    ...
                    n("video[data-loop]").each(function() {
                        var e = this,
                            t = n(this);
                        new o.Scene({ triggerHook: "onCenter", triggerElement: "[data-loop]", reverse: !1 })
                            .on("start", function() {
                                e.play(),
                                    t.on("ended", function(i) {
                ...
                b.length > 0 &&
                    new o.Scene({ triggerHook: "onCenter", triggerElement: ".section-video-reveal video", reverse: !1 })
                    .on("start", function(e) {
                        ...
                        t[0].play(),
                            t.on("ended", function() {
                                i.length > 0 &&
                                    i.fadeIn(250).on("click", function() {
                ...
                if (_.length > 0 && Modernizr.desktop && Modernizr.mq(z)) {
                    var y = new o.Controller({ globalSceneOptions: { triggerHook: "onEnter", duration: "200%" } });
                    _.each(function() {
                        new o.Scene({ triggerElement: this }).setTween(n(this).find(".bg").get(0), { y: "50%", ease: Power0.easeNone }).addTo(y);
                    });
                }
                ...
                if (k.length > 0) {
                    ...
                    k.each(function() {
                        new o.Scene({ triggerElement: this, offset: x, triggerHook: "onCenter" })
                            .setTween(n(this).find(".bg-second").get(0), 0.3, { opacity: "0", ease: Power0.easeNone })
                            .setClassToggle(n(this).parent().get(0), "changed")
                            .addTo(j);
                    });
                }
                var T = n(".section-feature-slider"),
                    ...
                    C = 2 === P.length;
                T.length > 0 &&
                    new s(".section-feature-slider .swiper-container", {
                        simulateTouch: !1,
                        loop: !0,
                        autoplay: 3e3,
                        effect: "fade",
                ...
                var S = n(".icon-slider");
                S.length > 0 && new s(".icon-slider", { simulateTouch: !1, loop: !0, autoplay: 1e3, speed: 500, slidesPerView: 6 }).disableTouchControl(),
                    n(".section-swap").each(function() {
                        var e = n(this),
                ...
                if (N.length > 0) {
                    ...
                    N.each(function() {
                        new o.Scene({ triggerElement: this }).setClassToggle(this, "active").addTo(A);
                    });
                }
                var R = n(".siriwave");
                R.length > 0 &&
                    R.each(function() {
                        ...
                        return (
                            ...
                            (n(".siriwave").html(""), n(".siriwave").html('<img src="https://www.fibaro.com/en/wp-content/uploads/sites/3/2017/02/siriwave_ie.png" alt="Sirivawe" style="width: 100%; height: auto;">')) :
                            new d({ speed: 0.07, amplitude: 0.8, container: this, autostart: !0, cover: !0 }), !1
                        );
                    });
                ...
                M.length > 0 &&
                    ...
                    n("[data-video-id], [data-playlist-id]").on("click", function(e) {
                        ...
                        var i = n(this).is("[data-video-id]"),
                            ...
                            s = n("video"),
                            r = i ?
                            '<iframe class="embed-responsive-item" src="//www.youtube.com/embed/' + o + '?rel=0&autoplay=1" allowfullscreen></iframe>' :
                            '<iframe class="embed-responsive-item" src="//www.youtube.com/embed/videoseries?list=' + o + '&rel=0&autoplay=1" allowfullscreen></iframe>';
                        s.each(function() {
                                n(this)[0].pause();
                            }),
                            n("body").append(
                                '<div class="popup-overlay popup-video"><div class="container"><div class="row"><div class="col-phoneS-12"><div class="embed-responsive embed-responsive-16by9">' +
                                r +
                ...
                L("hkf-cookie-info-closed"),
                    n(".footnotes-link").on("click", function(e) {
                        e.preventDefault(), a.to(window, 0, { scrollTo: { y: "#footnotes", offsetY: 90 } });
                    }),
                    ("pl" === n("html").attr("lang") || "pl-PL" === n("html").attr("lang") || n(".site-wrapper").hasClass("lang-pl")) &&
                    n("h1, h2, h3, p, li, span, .textcontent p, .typography-fix, .content").typographer({ modules: ["orphan"] }),
                    n(window).one("scroll", function() {
                        e();
                    }),
                    Modernizr.webp && n(".site-wrapper").addClass("webp");
        ...
        { 10: 10, 11: 11, 12: 12, 13: 13, 5: 5, 8: 8, 9: 9, undefined: void 0 },
    ],
}, {}, [14]);